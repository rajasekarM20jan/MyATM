...
public class atmOptions_Tamil extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_atm_options_tamil);
        withdraw=(Button) findViewById(R.id.withdrawTam);
        checkBalance=(Button) findViewById(R.id.balanceCheckTam);
        Intent a=getIntent();
    ...
    void getintent(){
        Intent i=new Intent(this,withdrawalPage_Tamil.class);
        i.putExtra("debitCardNumber",debitCard);
        i.putExtra("balance",balance);
        startActivity(i);
    }
    void getBalPage(){
        Intent i=new Intent(this,balancePage_Tamil.class);
        i.putExtra("debitCardNumber",debitCard);
        i.putExtra("balance",balance);
        startActivity(i);
    }
