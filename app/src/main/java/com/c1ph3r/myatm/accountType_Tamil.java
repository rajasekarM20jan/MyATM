...
public class accountType_Tamil extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_account_type_tamil);
        savings=(Button) findViewById(R.id.savingsAccountTam);
        current=(Button) findViewById(R.id.currentAccountTam);
        Intent a=getIntent();
    ...
    void getintent(){
        Intent i=new Intent(this,atmOptions_Tamil.class);
