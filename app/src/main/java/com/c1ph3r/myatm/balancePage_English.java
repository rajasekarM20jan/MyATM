...
public class balancePage_English extends AppCompatActivity {
    ArrayList<Database> fromJson = new ArrayList<>();
    Button next;
    TextView txt;
    String debitCard,balance;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_balance_page_english);
        Intent a=getIntent();
        debitCard=a.getStringExtra("debitCardNumber");
        next=(Button) findViewById(R.id.okInBalPage);
        txt=(TextView) findViewById(R.id.displayBalance);
        try {
            getdata();
            click();
        } catch (Exception e) {
