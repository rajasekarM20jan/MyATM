...
public class getAccountDetails_Tamil extends AppCompatActivity {
    ArrayList<Database> fromJson = new ArrayList<>();
    Button next;
    EditText debitCard,pin;
    public getAccountDetails_Tamil() throws Exception {
    }

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_get_account_details_tamil);
        next=(Button) findViewById(R.id.nextInAccDetailsTam);
        debitCard=(EditText) findViewById(R.id.etForCardDetailsTam);
        pin=(EditText) findViewById(R.id.etForPasswordTam);
        try {
            getdata();
            click();
        } catch (Exception e) {
    ...
    void click(){
        ...
        void getintent(){
            Intent i=new Intent(this,accountType_Tamil.class);
